...
export const auth: PlatformAuth = createOAuthAppAuth({
	...
	launcher: createWhisperingOAuthLauncher(),
});
...
function createWhisperingOAuthLauncher(): OAuthLauncher {
	const redirectUri = EPICENTER_WHISPERING_TAURI_OAUTH_REDIRECT_URI;
