---
name: drizzle-orm
description: Drizzle ORM patterns: type branding, custom types, SQLite column definitions. Use when mentioning Drizzle, drizzle-orm, DB schemas, branded column types.
metadata:
  author: epicenter
  version: '1.0'
---
