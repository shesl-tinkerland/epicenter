...
description: Scaffold Better Auth in TS/JS apps: detect frameworks, configure DB adapters, set up route handlers, add OAuth, create auth UI pages. Use when adding login, sign-up, or authentication.
metadata:
  author: epicenter
  version: '1.0'
---
