 ...
 * DERIVED from the row id (the 4-part grammar from `doc-guid.ts`), so the worker
 ...
 * derivation is why the worker's observe loop and the client opener land on the
 * same room.
 */
